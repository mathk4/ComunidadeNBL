...
- O layout foi **adaptado e customizado** a partir do modelo ensinado no curso, de acordo com a proposta do projeto.
...
- O uso de **SQL** foi feito em nível básico, limitado ao conteúdo ensinado no curso, apenas para possibilitar o funcionamento do sistema.
